...
namespace Booking_Tickets.Migrations
{
    ...
    [Migration("20240916150911_addOrganizeby")]
    partial class addOrganizeby
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Booking_Tickets.Data.Entites.Event", b =>
                {
                    ...
                    b.Property<string>("FirstTeamImage")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SecondTeamImage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Booking_Tickets.Data.Entites.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedAt = new DateTime(2024, 9, 16, 15, 9, 5, 155, DateTimeKind.Utc).AddTicks(726),
                            FullName = "Admin",
